  ...
  >
    ...
    <div className="relative z-10 pt-20">
        <motion.h1 variants={fadeUp} className="text-5xl md:text-6xl font-bold mb-6 text-white">
          AI Voice & Video Tools
        </motion.h1>
      <motion.p variants={fadeUp} className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto mb-8">
        Transform your communication and content creation with advanced AI voice and video solutions. Instantly generate lifelike voiceovers, automate video editing, and reach global audiences with real-time translation and dubbing.
      </motion.p>
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="flex w-full justify-between items-start relative z-10">
          ...
          <div className="flex flex-col items-center w-1/5">
            ...
            <div className="font-bold text-lg mb-1 text-center">Voice Synthesis</div>
            <div className="text-xs text-center text-gray-600">Generate natural-sounding voices for narration, assistants, and media.</div>
          </div>
          {/* Step 2 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Video Editing</div>
            <div className="text-xs text-center text-gray-600">Automate video editing, enhancement, and effects with AI.</div>
          </div>
          {/* Step 3 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Translation & Dubbing</div>
            <div className="text-xs text-center text-gray-600">Translate and dub audio/video in real time for global reach.</div>
          </div>
          {/* Step 4 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Speech Recognition</div>
            <div className="text-xs text-center text-gray-600">Convert speech to text for accessibility and content creation.</div>
          </div>
          {/* Step 5 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Publish & Support</div>
            <div className="text-xs text-center text-gray-600">Publish your audio/video and get ongoing support for updates and new requests.</div>
          </div>
        </div>
        {/* Dots on the line */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-0 items-center relative z-10 -space-x-8">
        <div className="flex-1 flex flex-col justify-center items-start mb-10 md:mb-0 md:pr-8">
          <h2 className={`text-4xl md:text-5xl font-extrabold mb-2 mt-0 ${theme === 'dark' ? 'text-black' : 'text-white'}`}>Features & Benefits</h2>
           <p className={`text-xl mb-6 max-w-lg ${theme === 'dark' ? 'text-white' : 'text-white'}`}>Our AI voice and video tools empower you to create professional-grade audio and video content, automate editing, and reach global audiences with real-time translation and dubbing.<br /><br />
          ...
          <ul className={`list-disc pl-5 text-lg mb-8 space-y-2 ${theme === 'dark' ? 'text-white' : 'text-white'}`}>
            <li>Produce lifelike voiceovers and narrations</li>
            <li>Automate video editing and enhancement</li>
            <li>Convert speech to text and vice versa</li>
            <li>Expand your reach with instant translation</li>
          </ul>
        </div>
...
const UseCasesSection = ({ theme }) => {
  const useCases = [
    {
      icon: voiceOverIcon,
      title: 'Voiceovers for Videos',
      desc: 'Create professional voiceovers for explainer videos, ads, and presentations.'
    },
    {
      icon: podcastIcon,
      title: 'Podcast Production',
      desc: 'Automate editing and enhancement for podcasts and audio shows.'
    },
    {
      icon: educationIcon,
      title: 'E-Learning Content',
      desc: 'Generate narration and video lessons for online courses.'
    },
    {
      icon: accessibilityIcon,
      title: 'Accessibility Solutions',
      desc: 'Convert speech to text and provide real-time translation for accessibility.'
    }
  ];
        ...
        <div className="mb-10 text-left">
          <h2 className="text-5xl font-extrabold mb-2 bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(to right, #63342e, #312525, #d6ab88, #c58d6a, #9a644a, #63342e, #312525)' }}>
           ...
           <p className="text-lg text-white max-w-2xl mb-8 leading-relaxed">
            See how AI voice and video tools are revolutionizing content creation, communication, and accessibility for creators, educators, and businesses.<br />
...
const CTASection = () => (
  <section className={`py-16 px-4 w-full`} style={{background: 'white'}}>
    <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
      <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#312525]">Unlock Insights with Data Analysis</h2>
      <p className={`text-lg mb-8 max-w-2xl text-black`}>
        Discover hidden trends, forecast future outcomes, and make smarter decisions with AI-powered data analysis and forecasting.<br />
       </p>
