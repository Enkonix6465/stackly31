  ...
  >
    ...
    <div className="relative z-10 pt-20">
      ...
      <motion.p variants={fadeUp} className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto mb-8">
        Unlock creativity and productivity with AI-powered content generation tools. Instantly create articles, blogs, marketing copy, and more for any project or business need.
      </motion.p>
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="flex w-full justify-between items-start relative z-10">
          ...
          <div className="flex flex-col items-center w-1/5">
            ...
            <div className="font-bold text-lg mb-1 text-center">Content Brief & Planning</div>
            <div className="text-xs text-center text-gray-600">Share your topic, goals, and audience to help us tailor your content strategy.</div>
          </div>
          {/* Step 2 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Content Design</div>
            <div className="text-xs text-center text-gray-600">We outline and structure your content for clarity, SEO, and engagement.</div>
          </div>
          {/* Step 3 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">AI-Powered Generation</div>
            <div className="text-xs text-center text-gray-600">Our AI creates high-quality, original content based on your requirements.</div>
          </div>
          {/* Step 4 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Review & Optimization</div>
            <div className="text-xs text-center text-gray-600">Edit, optimize, and refine your content for tone, accuracy, and SEO.</div>
          </div>
          {/* Step 5 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="text-xs text-center text-gray-600">Publish your content and get ongoing support for updates and new requests.</div>
          </div>
        </div>
        {/* Dots on the line */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-0 items-center relative z-10 -space-x-8">
        <div className="flex-1 flex flex-col justify-center items-start mb-10 md:mb-0 md:pr-8">
          <h2 className={`text-4xl md:text-5xl font-extrabold mb-2 mt-0 ${theme === 'dark' ? 'text-black' : 'text-white'}`}>Features & Benefits</h2>
           <p className={`text-xl mb-6 max-w-lg ${theme === 'dark' ? 'text-white' : 'text-white'}`}>Our generative AI platform empowers you to produce original content, saving time and resources while maintaining quality and creativity. <br /><br />
             Enjoy seamless collaboration, instant editing, and built-in SEO optimization to maximize your content's impact.
          </p>
          <ul className={`list-disc pl-5 text-lg mb-8 space-y-2 ${theme === 'dark' ? 'text-white' : 'text-white'}`}>
            <li>Generate content for any platform</li>
            <li>Customize style and tone</li>
            <li>Collaborate with your team in real time</li>
            <li>Boost your online presence with SEO tools</li>
          </ul>
        </div>
        <div className="flex-1 grid grid-cols-2 lg:grid-cols-3 gap-8 w-full pt-20 pb-20 justify-items-center">
          {features.map((feature, idx) => (
            ...
            >
              <div className={`font-bold text-xl ${theme === 'dark' ? 'text-white' : 'text-black'}`}>{feature.title}</div>
            </div>
          ))}
        </div>
      </div>
  ...
  const useCases = [
    {
      ...
      desc: 'Generate technical articles, tutorials, and documentation for software products and platforms.'
    },
    {
      icon: blogCatTrends,
      title: 'Marketing & SEO Content',
      desc: 'Create high-impact marketing copy, product descriptions, and SEO-optimized web content.'
    },
    {
      icon: blogCatCase,
      title: 'Case Studies & Reports',
      desc: 'Produce detailed case studies, business reports, and whitepapers with data-driven insights.'
    },
    {
      icon: blogCatThought,
      title: 'Thought Leadership',
      desc: 'Publish expert opinions, analysis, and commentary to establish authority in your field.'
    }
  ];
...
const CTASection = () => (
  <section className={`py-16 px-4 w-full`} style={{background: 'white'}}>
    <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
      <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#312525]">Create Content Instantly with AI</h2>
      <p className={`text-lg mb-8 max-w-2xl text-black`}>
        Generate high-quality articles, blogs, marketing copy, and more—faster than ever. <br />
       </p>
