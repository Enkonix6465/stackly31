  ...
  >
    ...
    <div className="relative z-10 pt-20">
      ...
      <motion.p variants={fadeUp} className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto mb-8">
        Unleash your creativity with AI-powered image and design tools. Instantly create, edit, and enhance graphics, photos, and visual content for any project or brand.
      </motion.p>
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="flex w-full justify-between items-start relative z-10">
          ...
          <div className="flex flex-col items-center w-1/5">
            ...
            <div className="font-bold text-lg mb-1 text-center">Upload or Create</div>
           </div>
          {/* Step 2 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Edit & Enhance</div>
           </div>
          {/* Step 3 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Generate AI Art</div>
           </div>
          {/* Step 4 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Brand & Customize</div>
           </div>
          {/* Step 5 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Export & Share</div>
           </div>
        </div>
        {/* Dots on the line */}
...
const plans = [
    ...
    },
    {
      ...
      price: "$99",
      period: "/month",
      desc: "For designers & small teams",
      features: [
    ...
    },
    {
      ...
      price: "Custom",
      period: "",
      desc: "For agencies & organizations",
      features: [
...
const CTASection = () => (
  <section className={`py-16 px-4 w-full`} style={{background: 'white'}}>
    <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
      <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#312525]">Empower Your Business with AI Chatbots</h2>
      <p className={`text-lg mb-8 max-w-2xl text-black`}>
        Deliver instant, personalized support and automate customer interactions with intelligent AI chatbots and assistants.<br />
       </p>
