  ...
  >
    ...
    <div className="relative z-10 pt-20">
      ...
      <motion.p variants={fadeUp} className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto mb-8">
        Transform your business with intelligent AI chatbots and virtual assistants. Deliver instant, personalized support, automate routine tasks, and boost customer satisfaction across all channels.
      </motion.p>
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="flex w-full justify-between items-start relative z-10">
          ...
          <div className="flex flex-col items-center w-1/5">
            ...
            <div className="font-bold text-lg mb-1 text-center">Initiate Conversation</div>
            <div className="text-xs text-center text-gray-600">Users start a chat or request support through your website, app, or messaging platform.</div>
          </div>
          {/* Step 2 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Understand & Respond</div>
            <div className="text-xs text-center text-gray-600">AI chatbot analyzes queries, understands context, and provides instant, relevant answers.</div>
          </div>
          {/* Step 3 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Automate Tasks</div>
            <div className="text-xs text-center text-gray-600">Routine tasks like booking, scheduling, and data entry are handled automatically.</div>
          </div>
          {/* Step 4 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Escalate When Needed</div>
            <div className="text-xs text-center text-gray-600">Complex issues are escalated to human agents for seamless support.</div>
          </div>
          {/* Step 5 */}
          <div className="flex flex-col items-center w-1/5">
            <div className="w-16 h-16 rounded-full bg-black flex items-center justify-center mb-4">
            ...
            <div className="font-bold text-lg mb-1 text-center">Analyze & Improve</div>
            <div className="text-xs text-center text-gray-600">Monitor conversations, gather insights, and continuously improve chatbot performance.</div>
          </div>
        </div>
        {/* Dots on the line */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-0 items-center relative z-10 -space-x-8">
        <div className="flex-1 flex flex-col justify-center items-start mb-10 md:mb-0 md:pr-8">
          <h2 className={`text-4xl md:text-5xl font-extrabold mb-2 mt-0 ${theme === 'dark' ? 'text-black' : 'text-white'}`}>Features & Benefits</h2>
           <p className={`text-xl mb-6 max-w-lg ${theme === 'dark' ? 'text-white' : 'text-white'}`}>Our AI chatbots and assistants deliver instant, personalized support, automate routine tasks, and improve customer satisfaction across all channels.<br /><br />
             Integrate with websites, apps, and messaging platforms for seamless customer experiences.<br /><br />
             Benefit from advanced NLP, contextual memory, and real-time analytics to optimize every interaction.
          </p>
          <ul className={`list-disc pl-5 text-lg mb-8 space-y-2 ${theme === 'dark' ? 'text-white' : 'text-white'}`}>
            <li>24/7 automated customer support</li>
            <li>Human-like conversations powered by NLP</li>
            <li>Seamless integration with websites, apps, and messaging platforms</li>
            <li>Scalable to handle unlimited users and queries</li>
          </ul>
        </div>
  ...
  const useCases = [
    {
      ...
      desc: 'Automate FAQs, resolve issues, and provide instant help for users on any channel.'
    },
    {
      icon: blogCatTrends,
      title: 'Sales & Lead Generation',
      desc: 'Engage visitors, qualify leads, and guide customers through the buying process.'
    },
    {
      icon: blogCatCase,
      title: 'Appointment & Booking',
      desc: 'Schedule meetings, book services, and send reminders automatically.'
    },
    {
      icon: blogCatThought,
      title: 'Personalized Recommendations',
      desc: 'Suggest products, services, or content based on user preferences and history.'
    }
  ];
        ...
        <div className="mb-10 text-left">
          <h2 className="text-5xl font-extrabold mb-2 bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(to right, #63342e, #312525, #d6ab88, #c58d6a, #9a644a, #63342e, #312525)' }}>
           ...
           <p className="text-lg text-white max-w-2xl mb-8 leading-relaxed">
            Discover how AI chatbots and assistants are transforming customer engagement, sales, and operations for businesses of all sizes.<br />
            Our platform adapts to your needs, delivering instant support and automation for any use case.
          </p>
        </div>
...
const plans = [
    ...
    },
    {
      ...
      price: "$99",
      period: "/month",
      desc: "For growing teams & enterprises",
      features: [
        "Advanced NLP & AI",
      ...
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-stretch">
          {plans.map((plan, index) => (
            ...
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2" style={{
...
const CTASection = () => (
  <section className={`py-16 px-4 w-full`} style={{background: 'white'}}>
    <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
      <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#312525]">Automate Your Workflow Today</h2>
      <p className={`text-lg mb-8 max-w-2xl text-black`}>
        Streamline operations, automate repetitive tasks, and boost productivity with our AI-powered automation and workflow tools.<br />
       </p>
