      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className={`${theme === "dark" ? "flex flex-col items-start text-left" : "flex flex-col items-start text-left text-black"} w-full md:w-auto mb-8 md:mb-0`}>
            ...
            <h3 className="text-xl font-bold mb-6 text-[#312525]">AI Tools Company</h3>
          ...
          {/* Quick Links */}
          <div className={`${theme === "dark" ? "flex flex-col items-start text-left" : "flex flex-col items-start text-left text-black"} w-full md:w-auto mb-8 md:mb-0`}>
            <h3 className="text-xl font-bold mb-6 text-[#312525]">Quick Links</h3>
          ...
          {/* Services */}
          <div className={`${theme === "dark" ? "flex flex-col items-start text-left" : "flex flex-col items-start text-left text-black"} w-full md:w-auto mb-8 md:mb-0`}>
            <h3 className="text-xl font-bold mb-6 text-[#312525]">Our Services</h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={service.name}>
                  <button
                    ...
                    className={(theme === "dark" ? "text-gray-300" : "text-black") + " hover:text-[#A67C52] transition-colors duration-300 cursor-pointer w-full text-left"}
                  >
                    {service.name}
                  </button>
                </li>
          ...
          {/* Contact & CTA */}
          <div className={`${theme === "dark" ? "flex flex-col items-start text-left" : "flex flex-col items-start text-left text-black"} w-full md:w-auto mb-8 md:mb-0`}>
            <h3 className="text-xl font-bold mb-6 text-[#312525]">Get In Touch</h3>
      ...
      <div className="border-t border-gray-700 py-6 mt-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className={theme === "dark" ? "flex gap-6 text-sm text-gray-400 justify-center md:justify-end" : "flex gap-6 text-sm text-black justify-center md:justify-end"}>
            <a href="#" className="hover:text-[#A67C52] transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-[#A67C52] transition-colors">Terms of Service</a>
            <a href="#" className="hover:text-[#A67C52] transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
